...
const runRethLocally = async (options = {}) => {
    const { port = 8545, silent = true, dev = true, waitMs = 5000, verbosity = 1, devBlockMaxTx = 1, teeMockServer = true, } = options;
    ...
    if (!seismicDir) {
        throw new Error('Must provide SEISMIC_ROOT environment variable pointing to local seismic-reth repo');
    }
