---
description: Reference implementations for Seismic's precompiles. These are meant for use directly in your contracts; these are here to show how you would call these directly
---
