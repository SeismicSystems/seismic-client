...
Defined in: [packages/seismic-viem/src/chain.ts:75](https://github.com/SeismicSystems/seismic-client/blob/f9582ede0e1ab6ae9e7a70543134a36d1fb37484/packages/seismic-viem/src/chain.ts#L75)
