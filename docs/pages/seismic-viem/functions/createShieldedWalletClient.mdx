...
Defined in: [packages/seismic-viem/src/client.ts:247](https://github.com/SeismicSystems/seismic-client/blob/28a134c564158fd29efe2a733ec4051f374a91b4/packages/seismic-viem/src/client.ts#L247)
