...
> **createShieldedWalletClient**(`__namedParameters`): `Promise`\<[`ShieldedWalletClient`](/seismic-viem/type-aliases/ShieldedWalletClient.mdx)\<`Transport`, `Chain`, `Account`\>\>

Defined in: [packages/seismic-viem/src/client.ts:273](https://github.com/SeismicSystems/seismic-client/blob/a4d19b5c0f021acba98fd1a07111747e3fc472b0/packages/seismic-viem/src/client.ts#L273)
