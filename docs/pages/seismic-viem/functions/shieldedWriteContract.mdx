...
Defined in: [packages/seismic-viem/src/contract/write.ts:88](https://github.com/SeismicSystems/seismic-client/blob/a6a7a0985cddc207c634448fb7c4cca5845c8a81/packages/seismic-viem/src/contract/write.ts#L88)
