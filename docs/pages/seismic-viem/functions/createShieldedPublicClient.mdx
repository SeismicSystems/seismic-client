...
```ts
function createShieldedPublicClient<transport, chain, rpcSchema>(parameters): ShieldedPublicClient<transport, chain, undefined, rpcSchema>
```

Defined in: [packages/seismic-viem/src/client.ts:201](https://github.com/SeismicSystems/seismic-client/blob/fb2b70a799e0a58e95478a9bc32d3743c2d88729/packages/seismic-viem/src/client.ts#L201)
