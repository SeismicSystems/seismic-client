...
Defined in: [packages/seismic-react/src/config/chain.ts:85](https://github.com/SeismicSystems/seismic-client/blob/1cf28f7efa87d88dbbf125297b22238c4b4e0bba/packages/seismic-react/src/config/chain.ts#L85)
