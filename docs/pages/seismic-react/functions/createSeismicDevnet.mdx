...
Defined in: [packages/seismic-react/src/config/chain.ts:81](https://github.com/SeismicSystems/seismic-client/blob/fe4ea18662b9b9725dc8d15ad03bde6f01c024a3/packages/seismic-react/src/config/chain.ts#L81)
